...
/**
 * @brief Get strongly connected components of a directed graph O(V + E)
 * 
 * @param directed_graph directed graph
 * @param strongly_connected_components strongly connected components
 * 
*/
